...
<head>
    ...
    <title>ARENA FITNESS CENTER</title>
...
<body class="bg-gray-100 font-poppins text-warna-300 overflow-x-hidden">
    <div class="min-h-screen bg-gray-100">
        <nav
            class="hidden lg:block fixed top-0 left-0 right-0 z-40 h-16 bg-warna-50 boreder-b border-warna-100 shadow-sm">
            <div class="h-16 px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <!-- Logo -->
                    <div class="hidden lg:flex items-center flex-shrink-0">
                        <div
                            class="h-10 w-10 bg-[#0F172A] rounded-xl flex items-center justify-center shadow-lg shadow-slate-200 mr-3 group transition-transform hover:rotate-6">
                        ...
                        <a href="{{ route('dashboard') }}" class="flex flex-col leading-none">
                            ...
                            <span class="text-[9px] font-bold text-slate-400 tracking-[0.3em] uppercase">Center
                                Management</span>
                        </a>
                    </div>
                    ...
                    <div x-data="{ sidebarOpen: false }" class="lg:hidden">
                        ...
                        <div x-show="sidebarOpen" x-cloak
                            ...
                            @click="sidebarOpen = false" class="fixed inset-0 z-50 bg-warna-300/50">
                        </div>
                        ...
                        <div x-show="sidebarOpen" x-cloak
                            ...
                            <div class="flex items-center justify-between p-4 border-b border-gray-200">
                                <div class="flex items-center justify-center space-x-3">
                                    <button @click="sidebarOpen = false"
                                        class="flex items-center justify-center text-warna-300 hover:text-gray-600">
                                        <i class="fa-solid fa-angle-left text-xl "></i>
                                    </button>
                                    <h3 class="text-lg font-semibold text-warna-300">User Profile</h3>
                                </div>
                                <a href="{{ route('logout') }}"
                                    class="bg-warna-900 py-2 px-3 rounded-xl hover:bg-warna-900/80 transition-all active:scale-95"
                            ...
                            <div class="overflow-y-auto h-full">
                                <div
                                    class="mb-14 bg-white shadow-md rounded-lg px-6 py-10 w-full flex flex-col items-center ">
                                    ...
                                    <div class="w-full mt-10 space-y-6">
                                        ...
                                        <x-g-input label="Username" type="text" value="{{ Auth::user()->username }}"
                                            disabled
                                            class=" w-full disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed" />
                                        <x-g-input label="Email" type="email" value="{{ Auth::user()->email }}"
                                            disabled
                                            class=" w-full disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed" />
                                    ...
                                    <button wire:click="testPing"
                                        class="mt-10 w-full bg-warna-400 hover:bg-warna-400/80 text-white font-semibold py-2 px-4 rounded-lg transition-all active:scale-95">
                                        Edit Profil
                                    </button>
                                    <button wire:click=""
                                        class="mt-5 w-full bg-white border border-warna-400 hover:bg-warna-400 text-warna-400 hover:text-white font-semibold py-2 px-4 rounded-lg transition-all active:scale-95">
                                        Ganti Password
                                    </button>
                                </div>
                            </div>
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative hidden lg:block">
                        <i @click="dropdownOpen = !dropdownOpen"
                            class="mr-4 fa-solid fa-ellipsis-vertical text-2xl cursor-pointer text-warna-300 active:scale-95 transition-all hover:text-warna-400"></i>
