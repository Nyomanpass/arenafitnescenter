...
>
    <div class="container mx-auto flex items-center justify-between px-6 lg:px-14">
        ...
        <nav class="hidden lg:flex items-center">
            ...
            <div class="flex items-center space-x-4 border-l border-white/20 pl-8">
                <a href="{{ route('login') }}" class="text-xs font-bold uppercase tracking-widest text-white hover:text-[#D9FF00] transition-all">
                    Login
                </a>
        ...
        <button 
            ...
            class="lg:hidden group focus:outline-none">
            <div class="space-y-1.5">
                <span class="block w-8 h-0.5 bg-white transition-all duration-300" :class="mobileMenuOpen ? 'rotate-45 translate-y-2 !bg-[#D9FF00]' : ''"></span>
    ...
    >
        <nav class="flex flex-col items-center space-y-8 text-center">
            <a href="#home" @click="mobileMenuOpen = false" class="text-3xl font-black text-white hover:text-[#D9FF00] uppercase tracking-tighter">Home</a>
            <a href="#about" @click="mobileMenuOpen = false" class="text-3xl font-black text-white hover:text-[#D9FF00] uppercase tracking-tighter">About</a>
            <a href="#faq" @click="mobileMenuOpen = false" class="text-3xl font-black text-white hover:text-[#D9FF00] uppercase tracking-tighter">FAQ</a>
            <a href="#contact" @click="mobileMenuOpen = false" class="text-3xl font-black text-white hover:text-[#D9FF00] uppercase tracking-tighter">Contact</a>
            
            <div class="pt-8 flex flex-col space-y-4 w-64">
                <a href="{{ route('register') }}" class="py-4 bg-[#D9FF00] text-black font-black uppercase tracking-widest">Join Member</a>
                <a href="{{ route('login') }}" class="py-4 border border-white/20 text-white font-black uppercase tracking-widest">Login</a>
            </div>
        </nav>
    </div>
</header>
  ...
  <div class="container mx-auto px-6 lg:px-14 relative z-20">
    <div class="max-w-3xl">
      <div class="hidden md:flex items-center space-x-4 mb-6" data-aos="fade-down">
        ...
        <span class="text-[#D9FF00] font-bold tracking-[0.3em] text-sm uppercase">Pusat Kebugaran Jimbaran</span>
      </div>

      <h1 class="text-5xl md:text-6xl font-black text-white leading-none mb-8" data-aos="fade-up" data-aos-delay="200">
        BEAT YOUR <br>
      ...
      <p class="text-gray-400 text-lg md:text-xl max-w-xl mb-12 leading-relaxed font-light" data-aos="fade-up" data-aos-delay="400">
        Tempat latihan dengan fasilitas lengkap untuk Anda yang serius ingin bertransformasi. Tanpa drama, hanya hasil nyata.
      </p>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-10 mt-20 border-l-4 border-[#D9FF00] pl-8" data-aos="fade-left" data-aos-delay="800">
        <div>
...
<section id="about" class="py-24 bg-[#f4f4f4] relative overflow-hidden">
  ...
  <div class="container mx-auto px-6 lg:px-14">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
      <div class="group p-10 bg-white border border-gray-200 hover:border-[#D9FF00] transition-all duration-500 shadow-sm hover:shadow-xl">
        <div class="w-12 h-12 bg-[#1a1a1a] text-[#D9FF00] flex items-center justify-center font-black mb-8 group-hover:bg-[#D9FF00] group-hover:text-black transition-colors">
          01
        </div>
        <h4 class="text-xl font-black text-gray-900 mb-4 uppercase italic">Alat Standar Global</h4>
        <p class="text-gray-500 text-sm leading-relaxed">Peralatan lengkap dan modern yang dirawat rutin untuk keamanan dan kenyamanan latihan Anda.</p>
      </div>
      ...
      <div class="group p-10 bg-white border border-gray-200 hover:border-[#D9FF00] transition-all duration-500 shadow-sm hover:shadow-xl">
        ...
        <p class="text-gray-500 text-sm leading-relaxed">Tanpa biaya pendaftaran yang rumit. Pilih paket yang sesuai dengan budget dan target Anda.</p>
      </div>
      ...
      <div class="group p-10 bg-white border border-gray-200 hover:border-[#D9FF00] transition-all duration-500 shadow-sm hover:shadow-xl">
        ...
        <p class="text-gray-500 text-sm leading-relaxed">Sirkulasi udara maksimal dan tata letak alat yang lega, membuat latihan tidak terasa sesak.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="profil" class="py-24 bg-[#1a1a1a] relative">
  <div class="absolute top-0 left-0 w-full h-32 bg-[#f4f4f4] clip-path-your-choice" style="clip-path: polygon(0 0, 100% 0, 100% 20%, 0 100%);"></div>

  <div class="container mx-auto px-6 lg:px-14 relative z-10 mt-10">
    <div class="flex flex-col lg:flex-row items-center gap-16">
      <div class="w-full lg:w-1/2 relative group">
        <div class="relative z-10 overflow-hidden">
          <img src="gambarabout.webp" alt="Arena Fitness" class="rounded-none shadow-2xl filter grayscale group-hover:grayscale-0 transition-all duration-700">
        </div>
        <div class="absolute -bottom-4 -right-4 w-full h-full border-2 border-[#D9FF00] -z-10 group-hover:bottom-0 group-hover:right-0 transition-all"></div>
      </div>
      ...
      <div class="w-full lg:w-1/2">
        ...
        <h2 class="text-white text-4xl md:text-5xl font-black italic uppercase leading-none mb-8">
          LEBIH DARI <br>
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">SEKADAR GYM.</span>
        </h2>
        
        <p class="text-gray-300 text-lg border-l-4 border-[#D9FF00] pl-6 italic mb-8">
          "Kami membangun komunitas bagi mereka yang percaya bahwa kekuatan fisik adalah kunci mental yang hebat."
        </p>
...
<section id="member" class="py-24 bg-[#080808] relative overflow-hidden">
  ...
  <div class="container mx-auto px-6 lg:px-14 relative z-10">
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6">
      <div class="max-w-2xl">
        ...
        <h2 class="text-4xl md:text-5xl font-black text-white leading-tight">
          MULAI TRANSFORMASI <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-[#D9FF00] to-white">DALAM 5 LANGKAH.</span>
        </h2>
      </div>
      <p class="text-gray-500 max-w-xs text-sm border-l border-white/10 pl-6">
        Proses pendaftaran digital yang cepat. Tidak perlu antre lama, semua bisa dilakukan dari smartphone Anda.
      </p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
      
      <div class="group relative p-8 bg-[#111] border border-white/5 hover:border-[#D9FF00]/50 transition-all duration-500 overflow-hidden">
        <span class="absolute -right-4 -top-4 text-7xl font-black text-white/[0.03] group-hover:text-[#D9FF00]/10 transition-colors">01</span>
        <div class="relative z-10">
          <div class="w-12 h-12 bg-[#D9FF00] text-black flex items-center justify-center font-black text-xl mb-8 skew-x-[-12deg]">
            01
          </div>
          <h3 class="text-white font-bold text-xl mb-4 group-hover:text-[#D9FF00] transition-colors uppercase">Registrasi</h3>
          <p class="text-gray-500 text-sm leading-relaxed">Klik "Join Member" dan lengkapi formulir digital dengan data diri Anda.</p>
        </div>
      </div>

      <div class="group relative p-8 bg-[#111] border border-white/5 hover:border-[#D9FF00]/50 transition-all duration-500 overflow-hidden lg:mt-10">
        <span class="absolute -right-4 -top-4 text-7xl font-black text-white/[0.03] group-hover:text-[#D9FF00]/10 transition-colors">02</span>
        <div class="relative z-10">
          <div class="w-12 h-12 bg-[#D9FF00] text-black flex items-center justify-center font-black text-xl mb-8 skew-x-[-12deg]">
            02
          </div>
          <h3 class="text-white font-bold text-xl mb-4 group-hover:text-[#D9FF00] transition-colors uppercase">Aktivasi</h3>
          <p class="text-gray-500 text-sm leading-relaxed">Verifikasi akun melalui email yang kami kirimkan untuk keamanan data.</p>
        </div>
      </div>

      <div class="group relative p-8 bg-[#111] border border-white/5 hover:border-[#D9FF00]/50 transition-all duration-500 overflow-hidden">
        <span class="absolute -right-4 -top-4 text-7xl font-black text-white/[0.03] group-hover:text-[#D9FF00]/10 transition-colors">03</span>
        <div class="relative z-10">
          <div class="w-12 h-12 bg-[#D9FF00] text-black flex items-center justify-center font-black text-xl mb-8 skew-x-[-12deg]">
            03
          </div>
          <h3 class="text-white font-bold text-xl mb-4 group-hover:text-[#D9FF00] transition-colors uppercase">Payment</h3>
          <p class="text-gray-500 text-sm leading-relaxed">Lakukan pembayaran di kasir Arena Fitness sesuai paket pilihan Anda.</p>
        </div>
      </div>

      <div class="group relative p-8 bg-[#111] border border-white/5 hover:border-[#D9FF00]/50 transition-all duration-500 overflow-hidden lg:mt-10">
        <span class="absolute -right-4 -top-4 text-7xl font-black text-white/[0.03] group-hover:text-[#D9FF00]/10 transition-colors">04</span>
        <div class="relative z-10">
          <div class="w-12 h-12 bg-[#D9FF00] text-black flex items-center justify-center font-black text-xl mb-8 skew-x-[-12deg]">
            04
          </div>
          <h3 class="text-white font-bold text-xl mb-4 group-hover:text-[#D9FF00] transition-colors uppercase">Verify</h3>
          <p class="text-gray-500 text-sm leading-relaxed">Admin akan memvalidasi pembayaran Anda dalam hitungan menit.</p>
        </div>
      </div>

      <div class="group relative p-8 bg-[#111] border border-white/5 hover:border-[#D9FF00]/50 transition-all duration-500 overflow-hidden">
        <span class="absolute -right-4 -top-4 text-7xl font-black text-white/[0.03] group-hover:text-[#D9FF00]/10 transition-colors">05</span>
        <div class="relative z-10">
          <div class="w-12 h-12 bg-[#D9FF00] text-black flex items-center justify-center font-black text-xl mb-8 skew-x-[-12deg]">
            05
          </div>
          <h3 class="text-white font-bold text-xl mb-4 group-hover:text-[#D9FF00] transition-colors uppercase">Training</h3>
          <p class="text-gray-500 text-sm leading-relaxed">Selesai! Dashboard aktif dan Anda siap membakar kalori di gym.</p>
        </div>
      </div>
    ...
    <div class="mt-20 flex justify-center">
        <a href="{{ route('register') }}" class="group flex items-center gap-4 bg-transparent border border-white/20 px-8 py-4 text-white hover:bg-[#D9FF00] hover:text-black hover:border-[#D9FF00] transition-all duration-300">
...
<section id="price" class="py-24 bg-[#f4f4f4] relative overflow-hidden">
  <div class="container mx-auto px-6 lg:px-14 relative z-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
      ...
      <div class="group relative bg-white border border-gray-200 p-10 transition-all duration-500 hover:shadow-2xl hover:border-[#D9FF00]">
        <div class="flex justify-between items-start mb-12">
          ...
          <div class="w-12 h-12 bg-gray-100 flex items-center justify-center text-gray-400 group-hover:bg-[#D9FF00] group-hover:text-black transition-colors">
        ...
        <button class="w-full py-4 border-2 border-gray-900 text-gray-900 font-black uppercase tracking-widest text-xs hover:bg-gray-900 hover:text-white transition-all">
          Coba Hari Ini
        </button>
      </div>

      <div class="group relative bg-[#111] p-10 transition-all duration-500 shadow-2xl scale-105 z-10 overflow-hidden">
        <div class="absolute top-0 right-0 bg-[#D9FF00] text-black font-black text-[10px] px-6 py-2 uppercase tracking-widest rotate-0">
          Best Value
        </div>

        <div class="flex justify-between items-start mb-12">
          <div>
            <h3 class="text-2xl font-black text-white uppercase italic leading-none">Monthly Member</h3>
            <p class="text-[#D9FF00] text-xs mt-2 uppercase tracking-widest font-bold">Akses Tanpa Batas</p>
          </div>
        ...
        <a href="{{ route('register') }}" class="block w-full py-4 bg-[#D9FF00] text-black text-center font-black uppercase tracking-widest text-xs hover:bg-white transition-all">
  ...
  <div class="container mx-auto px-6 lg:px-14 relative z-10">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
      ...
      <div class="lg:col-span-2">
        <div class="flex items-center gap-4 mb-8">
            <div class="w-12 h-12 bg-[#D9FF00] flex items-center justify-center font-black text-2xl italic text-black">A</div>
            <h2 class="text-white text-3xl font-black tracking-tighter uppercase">ARENA <span class="text-[#D9FF00]">FITNESS.</span></h2>
        </div>
        <p class="text-gray-500 text-sm leading-relaxed max-w-sm mb-8">
          Pusat kebugaran modern di Jimbaran yang fokus pada hasil nyata. Dilengkapi fasilitas import dan lingkungan latihan yang agresif namun nyaman.
        </p>
        <div class="flex gap-4">
          <a href="#" class="w-10 h-10 border border-white/10 flex items-center justify-center text-white hover:bg-[#D9FF00] hover:text-black transition-all"><i class="fab fa-instagram"></i></a>
          <a href="#" class="w-10 h-10 border border-white/10 flex items-center justify-center text-white hover:bg-[#D9FF00] hover:text-black transition-all"><i class="fab fa-tiktok"></i></a>
          <a href="#" class="w-10 h-10 border border-white/10 flex items-center justify-center text-white hover:bg-[#D9FF00] hover:text-black transition-all"><i class="fab fa-facebook-f"></i></a>
        </div>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4 text-gray-500 text-sm font-bold uppercase">
          <li><a href="#home" class="hover:text-[#D9FF00] transition-colors tracking-widest">Home</a></li>
          <li><a href="#about" class="hover:text-[#D9FF00] transition-colors tracking-widest">The Standard</a></li>
          <li><a href="#harga-member" class="hover:text-[#D9FF00] transition-colors tracking-widest">Membership</a></li>
          <li><a href="#contact" class="hover:text-[#D9FF00] transition-colors tracking-widest">Contact</a></li>
        </ul>
      </div>

      <div>
        <h4 class="text-white font-black uppercase tracking-[0.2em] text-xs mb-8">Ready to Start?</h4>
        <p class="text-gray-500 text-xs mb-6 uppercase tracking-widest">Daftar sekarang dan dapatkan akses penuh hari ini.</p>
        <a href="{{ route('register') }}" class="inline-block w-full py-4 bg-white text-black text-center font-black uppercase tracking-widest text-[10px] hover:bg-[#D9FF00] transition-all">
          Join The Member
        </a>
      </div>
    </div>
    ...
    <div class="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div class="flex gap-8">
        <a href="#" class="text-gray-600 text-[10px] font-bold uppercase tracking-widest hover:text-white transition-colors">Privacy Policy</a>
        <a href="#" class="text-gray-600 text-[10px] font-bold uppercase tracking-widest hover:text-white transition-colors">Terms</a>
      </div>
    </div>
  </div>
