...
<body
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <div style="background:#0F172A; padding: 40px 20px; text-align: center;">
            <h1
                style="color: #D9FF00; margin: 0; font-size: 32px; font-weight: bold; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">
                ARENA FITNESS CENTER
            </h1>
            <p style="color: white; margin: 10px 0 0 0; font-size: 16px;">
                Beat Your Limits with Us!
            </p>
        </div>
        ...
        <div style="padding: 40px 30px;">
            <div style="text-align: center; margin-bottom: 30px;">
                <div
                    style="width: 80px; height: 80px; background: #0F172A; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 15px rgba(244, 136, 1, 0.3);">
            ...
            <div
                style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; border-left: 4px solid #0F172A; margin-bottom: 30px;">
                <p style="margin: 0; color: #555; font-size: 16px; line-height: 1.6;">
                    Terima kasih telah bergabung dengan <strong>ARENA FITNESS CENTER</strong>! 🎉<br>
            ...
            <!-- Alternative Link -->
            <div style="background-color: rgba(15, 23, 42, 0.20); padding: 20px; border-radius: 8px; margin: 30px 0;">
                <p style="margin: 0 0 10px 0; color: #666; font-size: 14px;">
                    <strong>🔗 Link alternatif:</strong> Jika tombol tidak berfungsi, salin URL berikut:
                </p>
                <p
                    style="background-color: white; padding: 10px; border-radius: 5px; word-break: break-all; color: #0F172A; font-family: monospace; font-size: 12px; margin: 0; border: 1px dashed #0F172A;">
            ...
            <!-- Important Note -->
            <div
                style="background-color: #fff8f0; border: 1px solid #ffd700; border-radius: 8px; padding: 20px; margin: 30px 0;">
        ...
        <div style="background-color: #2c3e50; padding: 30px; text-align: center;">
            ...
            <p style="color: #7f8c8d; margin: 0; font-size: 12px;">
                © 2025 ARENAFITNESCENTER. Semua hak dilindungi.
            </p>
            <div style="margin-top: 15px;">
                <span style="color: #95a5a6; font-size: 12px;">
                    📧 arenafitness@gmail.com | 📞 +62 811-3333-1144
                </span>
            </div>
        </div>
    </div>
